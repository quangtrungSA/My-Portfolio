...
import { MapPin, UserCircle, Sparkles } from "lucide-react";
...
export function AboutSection({ profile }: AboutSectionProps) {
  return (
    <section id="about" className="relative py-20 sm:py-28 overflow-hidden">
      {/* Morphing blobs */}
      <motion.div animate={{ borderRadius: ["40% 60% 70% 30%/40% 50% 60% 50%","70% 30% 50% 50%/30% 60% 40% 70%","40% 60% 70% 30%/40% 50% 60% 50%"], x: [0, 40, 0], y: [0, -25, 0] }}
        transition={{ repeat: Infinity, duration: 12, ease: "easeInOut" }}
        className="pointer-events-none absolute -z-10 left-[-8%] top-[5%] h-96 w-96 bg-violet-500/10 blur-[100px]" />
      <motion.div animate={{ borderRadius: ["60% 40% 30% 70%/60% 30% 70% 40%","30% 60% 70% 40%/50% 60% 30% 60%","60% 40% 30% 70%/60% 30% 70% 40%"], x: [0, -30, 0], y: [0, 35, 0] }}
        transition={{ repeat: Infinity, duration: 15, ease: "easeInOut", delay: 3 }}
        className="pointer-events-none absolute -z-10 right-[-8%] bottom-[5%] h-96 w-96 bg-purple-500/10 blur-[110px]" />
      <motion.div animate={{ scale: [1, 1.4, 1], opacity: [0.3, 0.7, 0.3], x: [0, 20, 0] }}
        transition={{ repeat: Infinity, duration: 8, ease: "easeInOut", delay: 5 }}
        className="pointer-events-none absolute -z-10 left-[40%] top-[35%] h-64 w-64 rounded-full bg-fuchsia-500/8 blur-[80px]" />
      <motion.div animate={{ scale: [1, 1.3, 1], opacity: [0.2, 0.5, 0.2] }}
        transition={{ repeat: Infinity, duration: 11, ease: "easeInOut", delay: 7 }}
        className="pointer-events-none absolute -z-10 left-[20%] bottom-[10%] h-56 w-56 rounded-full bg-indigo-500/8 blur-[80px]" />
      {/* Diagonal lines */}
      <div className="pointer-events-none absolute inset-0 -z-20 opacity-[0.03]"
        style={{ backgroundImage: "repeating-linear-gradient(45deg, rgba(139,92,246,1) 0px, rgba(139,92,246,1) 1px, transparent 1px, transparent 28px)" }} />
      {/* Edge travellers */}
      {[...Array(3)].map((_,i)=>(
        <motion.div key={`top-${i}`} className="pointer-events-none absolute z-0 top-0 h-[2px] w-16 rounded-full bg-gradient-to-r from-transparent via-violet-400/50 to-transparent"
          animate={{left:["-8%","108%"]}} transition={{repeat:Infinity,duration:6+i*1.5,delay:i*2,ease:"linear"}} />
      ))}
      {[...Array(2)].map((_,i)=>(
        <motion.div key={`bot-${i}`} className="pointer-events-none absolute z-0 bottom-0 h-[2px] w-20 rounded-full bg-gradient-to-r from-transparent via-purple-400/40 to-transparent"
          animate={{left:["108%","-8%"]}} transition={{repeat:Infinity,duration:8+i*2,delay:i*3,ease:"linear"}} />
      ))}
      {[...Array(2)].map((_,i)=>(
        <motion.div key={`left-${i}`} className="pointer-events-none absolute z-0 left-0 w-[2px] h-16 rounded-full bg-gradient-to-b from-transparent via-violet-400/40 to-transparent"
          animate={{top:["-10%","110%"]}} transition={{repeat:Infinity,duration:7+i*1.5,delay:i*2,ease:"linear"}} />
      ))}
      {[...Array(2)].map((_,i)=>(
        <motion.div key={`right-${i}`} className="pointer-events-none absolute z-0 right-0 w-[2px] h-16 rounded-full bg-gradient-to-b from-transparent via-fuchsia-400/40 to-transparent"
      ...
      <motion.div animate={{opacity:[0.3,0.7,0.3],scale:[1,1.2,1]}} transition={{repeat:Infinity,duration:4}}
        className="pointer-events-none absolute -z-10 top-0 left-0 h-36 w-36 rounded-br-full bg-violet-500/8 blur-[40px]" />
      ...
      <motion.div animate={{opacity:[0.3,0.7,0.3],scale:[1,1.2,1]}} transition={{repeat:Infinity,duration:4.5,delay:2.5}}
        className="pointer-events-none absolute -z-10 bottom-0 left-0 h-36 w-36 rounded-tr-full bg-fuchsia-500/8 blur-[40px]" />
      <motion.div animate={{opacity:[0.3,0.7,0.3],scale:[1,1.2,1]}} transition={{repeat:Infinity,duration:6,delay:0.8}}
        className="pointer-events-none absolute -z-10 bottom-0 right-0 h-36 w-36 rounded-tl-full bg-indigo-500/8 blur-[40px]" />
      {/* Twinkling dots */}
      {[{l:"1%",t:"15%",s:7,d:1.8,dl:0},{l:"2%",t:"45%",s:5,d:2.2,dl:0.5},{l:"1%",t:"75%",s:7,d:1.6,dl:0.9},{l:"96%",t:"20%",s:8,d:1.9,dl:0.3},{l:"97%",t:"55%",s:5,d:2.0,dl:0.7},{l:"96%",t:"82%",s:6,d:1.7,dl:0.2},{l:"38%",t:"1%",s:5,d:2.1,dl:0.6},{l:"65%",t:"98%",s:6,d:1.8,dl:1.0}].map((s,i)=>(
        <motion.div key={i} className="pointer-events-none absolute z-10 rounded-full bg-violet-300"
          style={{left:s.l,top:s.t,width:s.s,height:s.s,boxShadow:`0 0 ${s.s*2}px ${s.s}px rgba(139,92,246,0.3)`}}
          animate={{opacity:[0.2,0.7,0.2],scale:[0.8,1.2,0.8]}}
          transition={{repeat:Infinity,duration:s.d,delay:s.dl,ease:"easeInOut"}} />
      ))}
      {[{l:"2%",t:"30%",dl:0.3},{l:"96%",t:"38%",dl:1.0},{l:"1%",t:"62%",dl:0.7},{l:"97%",t:"70%",dl:0.5},{l:"42%",t:"1%",dl:1.2},{l:"60%",t:"98%",dl:0.8}].map((c,i)=>(
        <motion.div key={i} className="pointer-events-none absolute z-10" style={{left:c.l,top:c.t}}
          ...
          <svg width="12" height="12" viewBox="0 0 12 12"><line x1="6" y1="0" x2="6" y2="12" stroke="rgba(167,139,250,0.7)" strokeWidth="1.5" strokeLinecap="round"/><line x1="0" y1="6" x2="12" y2="6" stroke="rgba(167,139,250,0.7)" strokeWidth="1.5" strokeLinecap="round"/></svg>
        </motion.div>
      ))}
